...
3. [Livrables](#livrables)
   ...
   2. [Analyse des conditions juridiques d’utilisation des données initiales](#livrable2)
   3. [Mise en place d’une plateforme de développement avec les logiciels recommandés](#livrable3)
   ...
   5. [Création de rapports individuels évolutifs sur le travail réalisé](#livrable5)
   ...
   7. [Création de personas de clients susceptibles d’utiliser le site](#livrable7)
   8. [Rapport sur trois algorithmes au sein de l’application](#livrable8)
   9. [Prototypage de l’application](#livrable9)
